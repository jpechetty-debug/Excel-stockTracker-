...
## Corpus Check
- 713 files · ~1,054,824 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12312 nodes · 18296 edges · 814 communities (640 shown, 174 thin omitted)
- Extraction: 83% EXTRACTED · 17% INFERRED · 0% AMBIGUOUS · INFERRED: 3194 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fc6942fb`
...
1. `extract()` - 207 edges
2. `Changelog` - 153 edges
3. `ingest_scip_json()` - 81 edges
4. `_read_text()` - 76 edges
5. `main()` - 75 edges
6. `_labels()` - 72 edges
7. `Communities (141 total, 52 thin omitted)` - 71 edges
8. `extract_js()` - 62 edges
9. `_file_stem()` - 60 edges
10. `detect()` - 55 edges
...
## Communities (814 total, 174 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (153): 0.1.0 (2026-04-03), 0.1.1 (2026-04-04), 0.1.3 (2026-04-04), 0.1.4 (2026-04-05), 0.1.5 (2026-04-05), 0.1.6 (2026-04-05), 0.1.7 (2026-04-05), 0.1.8 (2026-04-05) (+145 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (135): build_community_index(), build_section_node_map(), CallflowOptions, classify_edges(), _community_text(), derive_flow_chain(), derive_sections_from_communities(), _describe_node() (+127 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (112): _apply_symbol_resolution_facts(), _augment_js_reexport_edges(), _augment_symbol_resolution_edges(), _collect_js_symbol_resolution_facts(), _collect_python_symbol_resolution_facts(), _contained_in_package(), _cpp_preprocess(), _csharp_classify_base() (+104 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (101): _agents_install(), _agents_platform_install(), _agents_platform_uninstall(), _agents_uninstall(), _always_on(), _amp_install(), _amp_legacy_cleanup(), _amp_uninstall() (+93 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (92): _agents_install(), _agents_uninstall(), _install(), _kilo_install(), _kilo_uninstall(), Tests for graphify install --platform routing., Project-scope amp install lands in .agents/skills, an Amp project search root., The user-scope `graphify uninstall` enumeration removes the amp skill. (+84 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (91): _is_noise_dir(), Return True if this directory name looks like a venv, cache, or dep dir., collect_files(), extract_json(), Extract structure and dependency edges from a *config/manifest* .json file., by_label_by_id(), _legacy_collect_files(), #1402: a class defined once but referenced via type annotations in N other (+83 more)
...
Cohesion: 0.05
Nodes (79): _anthropic_content(), _azure_client(), _backend_env_keys(), _backend_supports_vision(), _bedrock_content(), _bedrock_inference_config(), _build_image_refs(), _call_azure() (+71 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (81): _read_text(), _c_collect_type_refs(), _cpp_collect_type_refs(), _cpp_declarator_name(), _cpp_local_var_types(), _csharp_attribute_names(), _csharp_collect_type_refs(), _csharp_type_parameters_in_scope() (+73 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (75): affected_nodes(), AffectedHit, _bare_name(), format_affected(), _format_location(), _node_label(), _normalize_label(), _prefer_file_node() (+67 more)

### Community 10 - "Community 10"
Cohesion: 0.05
Nodes (78): extract_svelte(), _load_tsconfig_aliases(), Walk up from start_dir to find tsconfig.json and return compilerOptions.paths al, Resolve a JS/TS module path or specifier to a local source file.      With a P, Extract imports from .svelte files: script-block via JS AST + template regex fal, _resolve_js_module_path(), _import_targets(), Tests for #716 — TypeScript bare-path imports, Svelte 5 rune file imports (`fro (+70 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (64): attach_hyperedges(), Store hyperedges in the graph's metadata dict., generate(), _learning_section(), Append the ``## Work-memory lessons`` section, or nothing when empty., Mirrors export.safe_name so community hub filenames and report wikilinks always, _safe_community_name(), Surprising connections section shows confidence score next to INFERRED edges. (+56 more)
...
Cohesion: 0.05
Nodes (67): extract_fortran(), extract_julia(), extract_swift(), Extract classes, structs, protocols, functions, imports, and calls from a .swift, Extract modules, structs, functions, imports, and calls from a .jl file., Extract programs, modules, subroutines, functions, use statements, and calls fro, _node_by_label(), _normalize_symbol_label() (+59 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (65): extract_razor(), ASP.NET Razor component extractor. Moved verbatim from graphify/extract.py., Extract directives, component refs, and @code methods from .razor/.cshtml., extract_csproj(), extract_sln(), extract_slnx(), extract_xaml(), _project_xml_is_safe() (+57 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (65): Export graph as an Obsidian Canvas file - communities as groups, nodes as cards., Export graph as GraphML - opens in Gephi, yEd, and any GraphML-compatible tool., Generate an interactive vis.js HTML visualization of the graph.      Features:, to_canvas(), to_graphml(), to_html(), str, _case_collision_graph() (+57 more)
...
Cohesion: 0.05
Nodes (53): _devin_rules_install(), _devin_rules_uninstall(), Write .windsurf/rules/graphify.md for always-on Devin context., Remove .windsurf/rules/graphify.md., _devin_install_user(), Tests for graphify devin install / uninstall commands., The rules file installed by devin must use query-first policy., Installing rules twice does not change content and prints 'no change'. (+45 more)
...
Cohesion: 0.06
Nodes (25): Enum, main(), ExecutionContext, PipelineArtifacts, PipelineState, Pipeline Context Contains the ExecutionContext passed through every pipeline ste, Stores all intermediate domain outputs., The singular context object passed to every pipeline step. (+17 more)

### Community 29 - "Community 29"
Cohesion: 0.05
Nodes (40): _file_stem(), Stem used as the node-ID prefix for a file and its symbols.      The full path, extract_zig(), Zig extractor (tree-sitter). Moved verbatim from graphify/extract.py., Extract functions, structs, enums, unions, and imports from a .zig file., build_graph(), Graph, _augment_systemverilog_semantics() (+32 more)

### Community 30 - "Community 30"
Cohesion: 0.04
Nodes (46): _add_unrelated_semantic_pair(), Tests for watch.py - file watcher helpers (no watchdog required)., A rejected candidate keeps the marker paired with the existing graph., Changed files under followed symlinks retain their watched lexical path., Empty change set must not create an empty .pending_changes file., #1059: the process that acquires the lock must drain .pending_changes     and p, #1059: after the primary rebuild, the lock-holder must loop and drain     any p, #1059: changed_paths=None means a full-corpus rebuild — the queue     must not (+38 more)

### Community 31 - "Community 31"
Cohesion: 0.05
Nodes (51): extract_java(), extract_powershell(), extract_scala(), Extract classes, interfaces, methods, constructors, and imports from a .java fil, Extract classes, objects, functions, and imports from a .scala file., Extract functions, classes, methods, and using statements from a .ps1 file., _edge_labels(), `[[Foo alloc] init]` must emit a `references` edge to the project class Foo (#14 (+43 more)
...
Cohesion: 0.09
Nodes (47): aggregate_lessons(), Aggregate parsed memory docs into a deterministic lessons structure.      ``no, Render the aggregate into the deterministic LESSONS.md markdown body., render_lessons_md(), _days_before(), _doc(), Tests for `graphify reflect` and the work-memory reflection layer.  `graphify, Corroboration (k>=2) + sign decide the bucket, not raw frequency:     A is usef (+39 more)
...
Cohesion: 0.05
Nodes (42): extract_apex(), extract_php(), Extract classes, interfaces, enums, methods, and Salesforce constructs from, Extract classes, functions, methods, namespace uses, and calls from a .php file., Module-level arrow functions must still emit a node and capture their calls (#10, _relations(), test_apex_class_extraction(), test_apex_contains_and_method_relations() (+34 more)
...
Cohesion: 0.06
Nodes (35): make_graph(), _make_simple_graph(), Tests for analyze.py., Code↔paper edge should score higher than code↔code edge., INFERRED calls within the same language family must not be affected., Helper: build a small nx.Graph from node/edge specs., Multi-file graph: should find cross-file edges between real entities., _file_category falls back to 'doc' for unknown extensions, so INFERRED     call (+27 more)

### Community 77 - "Community 77"
Cohesion: 0.11
Nodes (36): extract_mcp_config(), is_mcp_config_path(), Return True when ``path`` is a recognised MCP config filename., Parse an MCP config file into Graphify nodes and edges.      Behaviour matches, _label_by_kind(), Tests for graphify.mcp_ingest — MCP config file extraction., _relations(), test_dispatch_does_not_reroute_generic_json() (+28 more)

### Community 78 - "Community 78"
Cohesion: 0.05
Nodes (40): ingest_scip_json(), Convert a SCIP-style JSON document into Graphify nodes and edges.      Paramet, Cross-document relationship resolves to the target document's node id., A relationship targeting a symbol NOT in any document creates a stub external no, `relative_path` as a non-string falls back to the function's source_file default, A symbol with `relationships: None` ingests without error and emits no edges., A symbol with `kind` as a non-string falls back to 'unknown'., An occurrence with a negative line number resolves source_location to empty. (+32 more)
...
Cohesion: 0.06
Nodes (34): load_extraction(), Legacy nodes with file_type=None (e.g. preserved from older graph.json     by `, Nodes missing file_type entirely should also be canonicalized to 'concept'., Unknown file_type values are coerced through the synonym mapper, falling     ba, Known invalid file_type values map to their canonical equivalents., #1145 ghost-merge: a semantic ghost collapses into the single AST node     shar, #1257: when two files with the same basename both define a symbol with the, Semantic subagents emit absolute source_file paths; build_from_json must     re (+26 more)
...
Cohesion: 0.06
Nodes (37): extract_dmf(), extract_kotlin(), Extract windows and controls from a .dmf interface file., Extract classes, objects, functions, and imports from a .kt/.kts file., _labels(), Local const/let/var inside an arrow callback must NOT emit a node (#1077)., Scope guard applies to TypeScript files too (shared _js_extra_walk path)., `class Foo : Bar by baz` wraps the delegated interface in an     `explicit_dele (+29 more)

### Community 86 - "Community 86"
Cohesion: 0.06
Nodes (35): Comprehensive tests for graphify.scip_ingest., Cross-symbol relationship within ONE document resolves via the symbol index., A symbol entry with `symbol: <int>` is silently skipped., Top-level non-dict shapes still return the empty result., `documents` as a non-list returns the empty result., When two docs both have `F#`, a relationship from b.py's F# to F# must     reso, Duplicate symbol records within the SAME document collapse to one node id     i, SCIP-supplied description must be HTML-escaped before reaching node     metadat (+27 more)

### Community 87 - "Community 87"
Cohesion: 0.07
Nodes (35): _extract_pascal_regex(), _extract_spock_fallback(), extract_sql(), _pascal_find_body(), _pascal_project_root(), _pascal_resolve_class(), _pascal_resolve_unit(), _pascal_split_bases() (+27 more)
...
Cohesion: 0.09
Nodes (33): Strip control characters and cap length.      Safe for embedding in JSON data, Return a control-character-free, HTML-escaped, bounded string., Sanitize a metadata value while preserving simple JSON-compatible types., Sanitize metadata keys and values before graph export.      Metadata is less c, sanitize_label(), sanitize_metadata(), _sanitize_metadata_string(), _sanitize_metadata_value() (+25 more)
...
Cohesion: 0.07
Nodes (35): extract_c(), extract_dm(), Extract types, procs, includes, and calls from a .dm/.dme file., Extract functions and includes from a .c/.h file., _calls(), _edges_with_relation(), Regression test for the call-walker `simple_identifier` /     `identifier` rena, test_c_call_edges_have_call_context() (+27 more)

### Community 92 - "Community 92"
Cohesion: 0.09
Nodes (33): _auto_follow_symlinks(), convert_office_file(), _could_contain_included_path(), count_words(), docx_to_markdown(), _env_command_args(), extract_pdf_text(), _file_within_size_cap() (+25 more)

### Community 93 - "Community 93"
Cohesion: 0.07
Nodes (31): _body_content(), Strip YAML frontmatter from Markdown content, returning only the body., Tests for graphify/cache.py., A .md file with no frontmatter is hashed by its full content., Non-.md files are still hashed by their full content., _body_content correctly strips YAML frontmatter., _body_content returns content unchanged when no frontmatter present., A document opening with a ``----`` thematic break has no frontmatter;     a lat (+23 more)
...
Cohesion: 0.09
Nodes (33): _apply_resource_limits(), _canonical_graph_for_compare(), _canonical_topology_for_compare(), _changed_path_candidates(), _drain_pending(), _git_head(), _is_relative_to(), _json_text() (+25 more)

### Community 96 - "Community 96"
Cohesion: 0.08
Nodes (13): BaseProcessor, CacheManager, createProcessor(), DataProcessor, GraphEvent, GraphifyDemo, GraphPair, Loggable (+5 more)
...
Cohesion: 0.07
Nodes (32): _cap_filename(), _cypher_escape(), _cypher_label(), _dedup_node_filenames(), _git_head(), _html_script(), _html_styles(), _hyperedge_script() (+24 more)
...
Cohesion: 0.07
Nodes (30): extract_bash(), Extract functions, source imports, and cross-function calls from a .sh file., extract_bash returns error dict when tree-sitter-bash not installed (mocked)., `$(build)` must not be recorded as a call edge to build()., `<(helper)` (process substitution) must not be recorded as a call edge., User-defined function shadowing an external command (install/find/etc.) must sti, Every bash file produces a `bash_entrypoint` node distinct from the file node, j, Top-level function call attaches to the entrypoint node, not orphaned. (+22 more)
...
Cohesion: 0.09
Nodes (29): build(), build_from_json(), build_merge(), deduplicate_by_label(), graph_has_legacy_ids(), _infer_merge_root(), _norm_label(), _norm_source_file() (+21 more)

### Community 114 - "Community 114"
Cohesion: 0.08
Nodes (16): for_content(), Core PixelPrompt implementation for rendering text as optimized images.  Key f, Configuration for text rendering to images., RenderConfig, Default config has minify=True., Test RenderConfig dataclass., Minified text should produce shorter images (fewer blank lines)., Minified rendering should use fewer tokens. (+8 more)
...
Cohesion: 0.07
Nodes (29): _platform_artifacts(), codex: spawn/wait/close_agent dispatch needing multi_agent = true., codex (was 4-value) and windows (was 5-value) now carry the superset., The extraction variant differs: codex compact, windows verbose., No split host emits a trigger: field — not part of Agent Skills spec (#1180)., Each dispatch variant lands in the right host's B2 slot., kiro, pi, claw use the compact extraction body; the rest use verbose., All twelve split hosts render exactly the eight on-demand references. (+21 more)

### Community 117 - "Community 117"
Cohesion: 0.08
Nodes (17): BaseProcessor, DataProcessor, Logger, Reader, ReaderLogger, Result, AuthedHttpClient, Connection (+9 more)
...
Cohesion: 0.1
Nodes (6): BaseClient, Shared implementation for Client and AsyncClient.     Handles auth, redirects,, Cookies, Headers, Core data models: URL, Headers, Cookies, Request, Response. These are the centr, URL

### Community 120 - "Community 120"
Cohesion: 0.1
Nodes (16): minify_text(), PixelPrompt, Renders text content as optimized PNG images for LLM context compression., Initialize PixelPrompt.          Args:             config: RenderConfig objec, Validate configuration values., Load available fonts for the system., Find an available TrueType font from the list.          Prefers Menlo (optimal, Measure character dimensions for the loaded monospace font. (+8 more)
...
Cohesion: 0.1
Nodes (23): _ApiKeyMiddleware, _build_http_app(), _build_server(), _filter_blank_stdin(), _infer_context_filters(), _main(), _MCPASGIApp, _node_search_text() (+15 more)
...
Cohesion: 0.07
Nodes (15): Test text minification for image rendering., Blank lines should be removed., Markdown ## headers should have prefix removed., All header levels (# through ######) should be stripped., Bold ** markers should be removed., Bold __ markers should be removed., Multiple spaces should collapse to one., Trailing whitespace should be removed. (+7 more)

### Community 128 - "Community 128"
Cohesion: 0.07
Nodes (27): API Reference, Citation, code:bash (pip install pixelprompt), code:python (def optimize_prompt(prompt: str, style: str = "concise") -> ), code:bibtex (@software{pixelprompt,), code:python (from pixelprompt import PixelPrompt, RenderConfig), code:python (from pixelprompt import RenderConfig, CONTENT_PRESETS), code:python (from pixelprompt import optimize_prompt, image_query) (+19 more)
...
Cohesion: 0.1
Nodes (14): Base, constants, add(), area(), Circle, Color, describe(), Geometry (+6 more)

### Community 136 - "Community 136"
Cohesion: 0.1
Nodes (17): estimate_compression_ratio(), estimate_tokens(), Estimate compression ratio when rendering text as images.      Uses the actual, Estimate token count for text using Claude's token counting rules.      Uses a, Tests for PixelPrompt utility functions., Test token count for empty text., Test token count for short text., Test token count for longer text. (+9 more)

### Community 137 - "Community 137"
Cohesion: 0.08
Nodes (26): code:bash (mkdir -p graphify-out), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash (# Detect the correct Python interpreter (handles uv tool, pi), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash ($(cat graphify-out/.graphify_python) -c ") (+18 more)
...
Cohesion: 0.12
Nodes (14): Auth, BasicAuth, BearerAuth, NetRCAuth, Authentication handlers. Auth objects are callables that modify a request befor, Load credentials from ~/.netrc based on the request host., Base class for all authentication handlers., Modify the request. May yield to inspect the response. (+6 more)
...
Cohesion: 0.08
Nodes (24): code:block1 (/graphify .                        # 어떤 폴더든 동작 - 코드베이스, 노트, ), code:block10 (- **graphify** (`~/.claude/skills/graphify/SKILL.md`) - any ), code:block11 (/graphify                          # 현재 디렉토리에서 실행), code:block2 (graphify-out/), code:block3 (# .graphifyignore), code:bash (pip install graphifyy && graphify install), code:block5 (/graphify .), code:bash (graphify query "show the auth flow" --graph graphify-out/gra) (+16 more)
...
Cohesion: 0.13
Nodes (22): Export graph as an Obsidian vault - one .md file per node with [[wikilinks]],, to_obsidian(), A generated `_1` suffix must not collide with a node whose literal label is, Two community labels differing only by case must each get their own     `_COMMU, test_to_obsidian_community_notes_case_collision(), test_to_obsidian_generated_suffix_doesnt_overwrite_literal(), _graph_with_dangling_member(), Regression test for issue #1236: to_obsidian must not crash with KeyError when (+14 more)
...
Cohesion: 0.08
Nodes (23): Tests for the tools/skillgen generator and the claude lean-core split.  skillg, Regression for #1461: every skill body that describes Step 3 extraction must, The committed codex/windows artifacts match a fresh render and expected/., Rendering twice yields byte-identical output (no timestamps/versions)., aider and devin render one inline body, no split and no references dir., Each monolith is diff-clean vs v8 except the file_type enum unification., Every line that differs from pristine v8 is a sanctioned change-class.      Th, render_always_on yields exactly the six always-on instruction files. (+15 more)

### Community 155 - "Community 155"
Cohesion: 0.08
Nodes (13): Test max chars calculation is reasonable., Test that invalid font size raises error., Test that invalid font family raises error., Test rendering simple text., Test rendering multiline text., Test that empty text raises error., Test that whitespace-only text raises error., Test that long text is split into multiple images. (+5 more)
...
Cohesion: 0.1
Nodes (13): Protocol, MarketDataProvider, name(), ProviderHealth, Base Provider Protocol Defines the strict read-only interface that all market da, Metadata regarding the provider's operational status., Protocol strictly for retrieving raw market and financial data.     Providers sh, Returns the current operational status of the provider. (+5 more)

### Community 158 - "Community 158"
Cohesion: 0.15
Nodes (18): calculate_cagr(), FinancialEngine, Financial Calculation Engine Produces objective facts regarding business quality, Calculates objective financial quality metrics., Takes raw standardized company financial data and calculates quality metrics., _revenue_cagr_from_history(), _safe_divide(), Unit tests for FinancialEngine, added when replacing the hardcoded `revenue_cagr (+10 more)
...
Cohesion: 0.11
Nodes (21): _bash_make_id(), _file_node_id_for_path(), find_unique_python_symbol(), ImportedSymbol, _module_stem(), parse_python_import_aliases(), Deterministic symbol indexing and conservative cross-file resolution helpers., Return the final module component used to match Graphify source stems. (+13 more)
...
Cohesion: 0.09
Nodes (13): Tests for content-type presets, compact_json, compare, and prompt helpers., Test cost comparison functionality., compare() should return a dict with expected keys., Longer text should show positive input savings., compare() should accept different model names., Unknown model should fall back to Opus pricing., Image dimensions in compare result should match num_images., Test MODEL_PRICING dict. (+5 more)

### Community 167 - "Community 167"
Cohesion: 0.09
Nodes (12): Test CONTENT_PRESETS dictionary and RenderConfig.for_content()., All four content types should be defined., Each preset should have required keys., Font sizes should match benchmark v2 findings., Code and config should NOT minify; prose and json should., for_content('prose') should return correct config., for_content('json') should return correct config., for_content('code') should return correct config. (+4 more)

### Community 168 - "Community 168"
Cohesion: 0.1
Nodes (19): _absolutize_source_files_in(), check_semantic_cache(), load_cached(), Inverse of :func:`_relativize_source_files_in`.      Re-anchor relative ``sour, Return cached extraction for this file if hash matches, else None.      Cache, Check semantic extraction cache for a list of absolute file paths.      Return, ``load_cached`` returns the same absolute-path shape that a fresh     extractio, Entries written by pre-versioning graphify (flat cache/ or unversioned     cach (+11 more)

### Community 169 - "Community 169"
Cohesion: 0.12
Nodes (20): gemini_install(), gemini_uninstall(), Idempotently update or append a graphify-owned section in shared files.      I, Copy skill file, write GEMINI.md section, and install BeforeTool hook., Remove the graphify section from GEMINI.md, uninstall hook, and remove skill fil, _replace_or_append_section(), _uninstall_gemini_hook(), test_gemini_install_idempotent() (+12 more)
...
Cohesion: 0.1
Nodes (21): code:bash (mkdir -p graphify-out), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash ($(cat graphify-out/.graphify_python) -c ") (+13 more)
...
Cohesion: 0.13
Nodes (8): Scoring Engine Decision Engine that interprets Financial Facts into Business Sco, Applies configurable investment policies to objective financial metrics., Interprets FinancialEngine metrics using rules/scoring.yaml., ScoringEngine, main(), Ad-hoc debug script used while investigating a zeroed-out metrics bug. Moved out, name(), StepScoring
...
Cohesion: 0.11
Nodes (19): load_memory_docs(), parse_memory_doc(), Parse the frontmatter of a memory doc into a dict, or None if it has none., Parse every memory doc under ``memory_dir``, sorted by date then filename., Reverse the double-quoted escaping that ingest._yaml_str applies., _yaml_unescape(), dead_ends/corrections are appended in doc order, so their determinism rides on, The headline guarantee: identical memory/ contents + same `now` -> byte-identica (+11 more)
...
Cohesion: 0.12
Nodes (18): build_label_index(), build_python_symbol_index(), node_is_resolvable_symbol(), _node_source_stem(), normalise_callable_label(), Return the stem of a node's source file., Build ``(module_stem, normalized_symbol_name) -> node_ids``.      This index i, Normalize a node label into the key used for call resolution. (+10 more)
...
Cohesion: 0.15
Nodes (11): optimize_prompt(), Add output-suppression suffix to a prompt for image-mode queries.      When se, Test prompt optimization helpers., Concise style should append CONCISE_SUFFIX., Extract style should append EXTRACT_SUFFIX., Structured style should append STRUCTURED_SUFFIX., None style should return prompt unchanged., Should not duplicate suffix if already present. (+3 more)

### Community 219 - "Community 219"
Cohesion: 0.11
Nodes (11): Tests for PixelPrompt core functionality., Test word wrapping functionality., Short lines should pass through unchanged., Empty lines should be preserved., Lines longer than max width should be word-wrapped., Words longer than max width should be force-split., Test text splitting functionality (backwards compat)., Test that short text is not split. (+3 more)
...
Cohesion: 0.12
Nodes (17): argparse `choices` rejects an unknown outcome before save_query_result runs., --answer-file lets callers pass a long/multiline answer via a file instead, Neither --answer nor --answer-file -> clean argparse error, not a crash., First run with no graphify-out/memory/ still succeeds and writes a valid doc., With a real graph.json present, reflect auto-detects it and groups lessons, Through reflect()/CLI with a real graph.json: a cited node that isn't in the, `reflect --if-stale` skips the rebuild when LESSONS.md is already current,, _run() (+9 more)
...
Cohesion: 0.17
Nodes (14): Remap community IDs to maximize overlap with a previous assignment.      Uses, remap_communities_to_previous(), make_graph(), Clustering should not emit ANSI escape codes or other output.      graspologic, Same as above but for stderr — ANSI codes can go to either stream., test_cluster_covers_all_nodes(), test_cluster_does_not_write_to_stderr(), test_cluster_does_not_write_to_stdout() (+6 more)
...
Cohesion: 0.15
Nodes (10): compact_json(), Test JSON compaction functionality., Pretty-printed JSON should be compacted., Already compact JSON should be unchanged., Nested JSON should be fully compacted., Invalid JSON should use regex fallback., Empty JSON objects should work., compact_json should be callable as PixelPrompt static method. (+2 more)
...
Cohesion: 0.15
Nodes (16): cache_dir(), _cleanup_stale_ast_entries(), prune_semantic_cache(), Returns the cache directory for ``kind`` - creates it if needed.      kind is, Remove AST cache entries left behind by other graphify versions.      Sweeps s, Remove orphaned semantic cache entries, returning the count pruned.      The s, Cache entries written by an older graphify (with absolute source_file     insid, Changing a file's content leaves the old content-hash entry orphaned;     pruni (+8 more)

### Community 261 - "Community 261"
Cohesion: 0.12
Nodes (16): Mutate ``payload`` to rewrite absolute ``source_file`` fields as     forward-sl, Save extraction result for this file.      Stores as graphify-out/cache/{kind}, Save semantic extraction results to cache, keyed by source_file.      Groups n, _relativize_source_files_in(), save_cached(), save_semantic_cache(), The on-disk cache JSON contains forward-slash relative source_file     entries, End-to-end portability: a cache entry written at one root can be     consumed a (+8 more)
...
Cohesion: 0.17
Nodes (15): _make_extraction(), Tests for confidence_score on edges., Edges lacking confidence_score get sensible defaults in to_json., Report summary line should include avg confidence for INFERRED edges., Return a minimal extraction dict with one edge of each confidence type., EXTRACTED edges must have confidence_score == 1.0., INFERRED edges must have confidence_score between 0.0 and 1.0., AMBIGUOUS edges must have confidence_score <= 0.4. (+7 more)
...
Cohesion: 0.12
Nodes (9): Test RenderedImage class., Test RenderedImage has dynamic size (not always 1568x1568)., Test tokens property reflects actual dimensions., Larger images should cost more tokens., Test PNG bytes export., Test base64 encoding., Test Anthropic API content block format., Test saving image to file. (+1 more)

### Community 272 - "Community 272"
Cohesion: 0.14
Nodes (10): PixelPrompt: Compress LLM context by rendering text as optimized images.  Base, image_query(), Prompt optimization helpers for image-mode LLM queries.  Key finding from benc, Build an optimized prompt for querying image-rendered content.      Creates a, Utility functions for PixelPrompt., Test image_query helper., Should build a complete image query prompt., Should use custom context instruction. (+2 more)
...
Cohesion: 0.16
Nodes (8): Session Manager Implements a reusable HTTP Session singleton to drastically impr, Manages a globally reusable requests Session., Initializes the requests session., Returns the shared requests session., Closes the active session., SessionManager, yfinance implementation wrapper.     Utilizes global SessionManager and RateLimi, YFinanceProvider
...
Cohesion: 0.22
Nodes (13): cached_files(), cached_word_count(), _ensure_stat_index(), file_hash(), _flush_stat_index(), _normalize_path(), Normalize path for consistent cache keys across Windows path spellings., SHA256 of file contents + path relative to root.      Uses a stat-based fastpa (+5 more)
...
Cohesion: 0.14
Nodes (8): FCL, IProcessor, SamplePackage, SampleUnit, TBaseProcessor, LCL, sampleutils, TObject
...
Cohesion: 0.19
Nodes (9): estimate_image_tokens(), Estimate Claude token cost for an image based on dimensions.      Uses officia, Test the image token estimation function., Token cost = (w * h) / 750., Small images should have low token cost., Dynamic width images should cost much less than full-size., Images larger than 1568 should be scaled down., Token count should be at least 1. (+1 more)

### Community 298 - "Community 298"
Cohesion: 0.14
Nodes (13): Benchmarks, code:bash (uv tool install graphifyy      # install the CLI (or: pipx i), code:block2 (/graphify .), code:block24 (/graphify                          # run on current director), code:block3 (graphify-out/), Community and links, Environment variables, Full command reference (+5 more)
...
Cohesion: 0.17
Nodes (13): _filter_graph_by_context(), _normalize_context_filters(), _query_graph_text(), _resolve_context_filters(), Full pipeline: '页面路由' should find nodes with '路由' in label., test_filter_graph_by_context_limits_traversal(), test_query_graph_text_context_filter_aliases_resolve(), test_query_graph_text_explicit_context_filter_changes_traversal() (+5 more)
...
Cohesion: 0.27
Nodes (12): _he_ids(), Incremental --update: hyperedge preservation (#1574) and root-less prune (#1571), A symlinked scan root (macOS /var -> /private/var, symlinked home/worktree), Write a graph.json in the shape to_json emits (top-level hyperedges)., The runbook omits root; the fallback root must not break preservation., _seed_two_file_graph(), test_deleted_file_hyperedges_are_pruned(), test_prune_matches_across_symlinked_root() (+4 more)

### Community 308 - "Community 308"
Cohesion: 0.17
Nodes (13): edge_data(), edge_datas(), Return one edge attribute dict for (u, v), tolerating MultiGraph.      For Mul, Return every edge attribute dict for (u, v); always a list., #1279: a semantic/LLM edge lacking source_file must inherit it from its     sou, A node_link JSON with multigraph: true must load as MultiGraph and the     help, test_edge_data_multidigraph(), test_edge_data_multigraph_with_parallel_edges() (+5 more)
...
Cohesion: 0.23
Nodes (12): cluster(), cohesion_score(), _partition(), Community detection on NetworkX graphs. Uses Leiden (graspologic) if available,, Context manager to suppress stdout/stderr during library calls.      graspolog, Run Leiden community detection. Returns {community_id: [node_ids]}.      Commu, Run community detection. Returns {node_id: community_id}.      Tries Leiden (g, Run a second Leiden pass on a community subgraph to split it further. (+4 more)
...
Cohesion: 0.2
Nodes (5): MarketDataProvider, MockProvider, name(), Mock Provider Provides deterministic, offline market data for end-to-end testing, Offline data provider returning hardcoded static dictionaries.     Extremely use
...
Cohesion: 0.17
Nodes (7): Test dynamic image sizing., Short lines should produce narrow images., Few lines should produce short images., Dynamic sizing should use fewer tokens than static., Static sizing should use full width/height., Long lines should be wrapped within max_width., TestDynamicSizing
...
Cohesion: 0.18
Nodes (11): extract_verilog(), Extract modules, functions, tasks, package imports, instantiations, and     Sys, Class properties with leading qualifiers (rand/local/protected/etc.) must     s, test_systemverilog_does_not_emit_type_parameter_refs(), test_systemverilog_field_parameter_return_and_generic_contexts(), test_systemverilog_missing_file_returns_empty(), test_systemverilog_no_dangling_edges(), test_systemverilog_no_error() (+3 more)
...
Cohesion: 0.24
Nodes (6): Represents a single rendered image with token cost metadata., Initialize with PIL Image.          Args:             image: PIL Image object, Get base64-encoded PNG for API integration., Convert to Anthropic API content block format.          Returns:, RenderedImage, size_bytes()
...
Cohesion: 0.22
Nodes (8): Re-derive non-AST node ids from ``source_file`` using the canonical     full-pa, _semantic_id_remap(), Re-key contract: a relative source_file is migrated; an absolute one is left, test_semantic_rekey_relative_vs_absolute_source_file(), A node whose source_file equals the scan root must not crash build (#1618).  `, test_file_stem_handles_dot_path(), test_normal_semantic_remap_still_works(), test_semantic_id_remap_root_equal_source_file_no_crash()
...
Cohesion: 0.29
Nodes (5): TDataProcessor, Process(), Reset(), IProcessor, TBaseProcessor
...
Cohesion: 0.5
Nodes (4): _match_tsconfig_alias(), Return (specificity, captured text, is_wildcard) when pattern matches raw., Resolve `raw` against the most specific matching tsconfig alias pattern., _resolve_tsconfig_alias()

### Community 551 - "Community 551"
Cohesion: 0.5
Nodes (4): _custom_providers_path(), _load_custom_providers(), provider_base_url_ok(), Structural safety check for a custom-provider base_url.      A custom provider
...
Cohesion: 0.5
Nodes (4): dedupe_edges(), Collapse exact parallel edges by ``(source, target, relation)``, keeping the, test_dedupe_edges_collapses_exact_parallels(), test_dedupe_edges_is_idempotent()
...
## Knowledge Gaps
- **5341 isolated node(s):** `Loads and provides access to YAML configurations.`, `Loads a YAML file from the config directory.`, `Loads a YAML file from an absolute or exact path.`, `Retrieves a nested setting using dot notation (e.g. 'application.threads').`, `Base exception for all custom IOS errors.` (+5336 more)
...
- **Why does `extract()` connect `Community 19` to `Community 2`, `Community 5`, `Community 9`, `Community 138`, `Community 268`, `Community 12`, `Community 142`, `Community 143`, `Community 16`, `Community 17`, `Community 18`, `Community 22`, `Community 152`, `Community 282`, `Community 29`, `Community 413`, `Community 31`, `Community 414`, `Community 37`, `Community 168`, `Community 170`, `Community 303`, `Community 432`, `Community 305`, `Community 306`, `Community 179`, `Community 564`, `Community 304`, `Community 433`, `Community 321`, `Community 194`, `Community 322`, `Community 457`, `Community 458`, `Community 340`, `Community 345`, `Community 346`, `Community 95`, `Community 490`, `Community 242`, `Community 115`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 3` to `Community 129`, `Community 7`, `Community 9`, `Community 11`, `Community 140`, `Community 15`, `Community 18`, `Community 153`, `Community 26`, `Community 287`, `Community 551`, `Community 168`, `Community 169`, `Community 301`, `Community 302`, `Community 430`, `Community 435`, `Community 308`, `Community 180`, `Community 60`, `Community 324`, `Community 69`, `Community 80`, `Community 90`, `Community 95`, `Community 99`, `Community 246`, `Community 124`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `TestRenderedImage` connect `Community 271` to `Community 353`, `Community 219`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Are the 495 inferred relationships involving `str` (e.g. with `_revenue_cagr_from_history()` and `_values_equivalent()`) actually correct?**
  _`str` has 495 INFERRED edges - model-reasoned connections that need verification._
- **Are the 187 inferred relationships involving `extract()` (e.g. with `str` and `_resolve_csharp_type_references()`) actually correct?**
  _`extract()` has 187 INFERRED edges - model-reasoned connections that need verification._
- **Are the 75 inferred relationships involving `ingest_scip_json()` (e.g. with `test_ingest_empty_doc_returns_empty_lists()` and `test_ingest_dict_without_documents_key()`) actually correct?**
  _`ingest_scip_json()` has 75 INFERRED edges - model-reasoned connections that need verification._
- **Are the 75 inferred relationships involving `_read_text()` (e.g. with `_python_collect_type_refs()` and `_csharp_pre_scan_interfaces()`) actually correct?**
  _`_read_text()` has 75 INFERRED edges - model-reasoned connections that need verification._